# -*- coding: utf-8 -*-
"""
Created on Thu Nov  9 18:50:26 2017
...
for x in participants:
    ...
    for sessions in glob.glob("%s\\*" %x): #Store list of sessions for current participant
        for files in glob.glob("%s\\*" %sessions):
            ...
            #sourcefile_emotion = glob.glob("source_images/S005/001/*")[-1] #get path for last image in sequence, which contains the emotion
