# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:54:47 2018
...
emotions = ["12","neutral"] #Emotion list
...
def main():
    ...
    with open('models/trained_12_model', 'wb') as f:
            pickle.dump(clf, f)

    with open('models/trained_12_accuracy.txt', 'w') as f:
