# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:53:04 2018
...
emotions = ["7","neutral"] #Emotion list
...
def get_landmarks(image):
    ...
    for i,face in enumerate(faces): #For all detected face instances individually
        ...
        for x, y, w, z in zip(xcentral[36:48], ycentral[36:48], xshape[36:48], yshape[36:48]): # paara hacer pares 
...
with open('models/trained_7_model', 'wb') as f:
        pickle.dump(clf, f)

with open('models/trained_7_accuracy.txt', 'w') as f:
