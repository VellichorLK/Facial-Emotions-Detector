# -*- coding: utf-8 -*-
"""
Created on Sat Apr 14 13:09:32 2018
...
emotions = ["1","neutral"] #Emotion list
...
with open('models/trained_1_model', 'wb') as f:
        pickle.dump(clf, f)

with open('models/trained_1_accuracy.txt', 'w') as f:
