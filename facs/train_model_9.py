# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:53:32 2018
...
emotions = ["9","neutral"] #Emotion list
...
with open('models/trained_9_model', 'wb') as f:
        pickle.dump(clf, f)

with open('models/trained_9_accuracy.txt', 'w') as f:
