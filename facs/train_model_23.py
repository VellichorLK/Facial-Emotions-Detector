# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:57:26 2018
...
emotions = ["23","neutral"] #Emotion list
...
def main():
    ...
    with open('models/trained_23_model', 'wb') as f:
            pickle.dump(clf, f)

    with open('models/trained_23_accuracy.txt', 'w') as f:
