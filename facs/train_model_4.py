    # -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:51:19 2018
...
emotions = ["4","neutral"] #Emotion list
...
with open('models/trained_4_model', 'wb') as f:
        pickle.dump(clf, f)

with open('models/trained_4_accuracy.txt', 'w') as f:
