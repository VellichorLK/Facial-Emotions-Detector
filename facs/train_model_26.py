# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:59:15 2018
...
emotions = ["26","neutral"] #Emotion list
...
def main():
    ...
    with open('models/trained_26_model', 'wb') as f:
            pickle.dump(clf, f)

    with open('models/trained_26_accuracy.txt', 'w') as f:
