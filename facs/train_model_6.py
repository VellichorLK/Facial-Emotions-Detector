# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:52:22 2018
...
emotions = ["6","neutral"] #Emotion list
...
with open('models/trained_6_model', 'wb') as f:
        pickle.dump(clf, f)

with open('models/trained_6_accuracy.txt', 'w') as f:
