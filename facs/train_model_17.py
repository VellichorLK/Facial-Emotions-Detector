# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:56:21 2018
...
emotions = ["17","neutral"] #Emotion list
...
def main():
    ...
    with open('models/trained_17_model', 'wb') as f:
            pickle.dump(clf, f)

    with open('models/trained_17_accuracy.txt', 'w') as f:
