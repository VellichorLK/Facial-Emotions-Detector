# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:50:47 2018
...
emotions = ["2","neutral"] #Emotion list
...
with open('models/trained_2_model', 'wb') as f:
        pickle.dump(clf, f)

with open('models/trained_2_accuracy.txt', 'w') as f:
