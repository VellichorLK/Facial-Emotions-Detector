# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:55:16 2018
...
emotions = ["14","neutral"] #Emotion list
...
def main():
    ...
    with open('models/trained_14_model', 'wb') as f:
            pickle.dump(clf, f)

    with open('models/trained_14_accuracy.txt', 'w') as f:
