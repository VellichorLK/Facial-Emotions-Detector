# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:51:47 2018
...
emotions = ["5","neutral"] #Emotion list
...
with open('models/trained_5_model', 'wb') as f:
        pickle.dump(clf, f)

with open('models/trained_5_accuracy.txt', 'w') as f:
