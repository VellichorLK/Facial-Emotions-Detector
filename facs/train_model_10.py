# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:54:04 2018
...
emotions = ["10","neutral"] #Emotion list
clahe = cv2.createCLAHE(clipLimit=2.0, tileGridSize=(8,8))
detector = dlib.get_frontal_face_detector()
predictor = dlib.shape_predictor("shape_predictor_68_face_landmarks.dat")
#lf = SVC(C = 10,kernel = 'sigmoid',gamma = 1e-8, probability=True, tol=1e-3)#, verbose = True) #Set the classifier as a support vector machines with polynomial kernel
...
def main():
    ...
    with open('models/trained_10_model', 'wb') as f:
            pickle.dump(clf, f)

    with open('models/trained_10_accuracy.txt', 'w') as f:
            f.write(str(np.mean(accur_lin)))