# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:55:58 2018
...
emotions = ["15","neutral"] #Emotion list
...
def main():
    ...
    with open('models/trained_15_model', 'wb') as f:
            pickle.dump(clf, f)

    with open('models/trained_15_accuracy.txt', 'w') as f:
