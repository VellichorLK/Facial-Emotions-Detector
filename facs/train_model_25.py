# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:58:43 2018
...
emotions = ["25","neutral"] #Emotion list
...
def main():
    ...
    with open('models/trained_25_model', 'wb') as f:
            pickle.dump(clf, f)

    with open('models/trained_25_accuracy.txt', 'w') as f:
