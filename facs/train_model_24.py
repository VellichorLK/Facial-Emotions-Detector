# -*- coding: utf-8 -*-
"""
Created on Mon Apr 16 11:57:54 2018
...
emotions = ["24","neutral"] #Emotion list
...
def main():
    ...
    with open('models/trained_24_model', 'wb') as f:
            pickle.dump(clf, f)

    with open('models/trained_24_accuracy.txt', 'w') as f:
